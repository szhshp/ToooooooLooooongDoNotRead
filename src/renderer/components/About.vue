    ...
    <v-card outlined elevation="4" class="mx-auto my-4">
      ...
      <v-card-actions>
        <v-btn
          ...
          color="primary"
          @click="
            openLinks('https://github.com/szhielelp/ToooooooLooooongDoNotRead')
          "
          >Github</v-btn
        >
      </v-card-actions>
    ...
    <v-card outlined elevation="4" class="mx-auto my-4">
      ...
      <v-card-actions>
        <v-btn
          ...
          text
          color="primary"
          @click="openLinks('https://github.com/szhielelp')"
          >Github</v-btn
        >
        <v-btn
          small
          text
          color="primary"
          @click="openLinks('https://szhshp.org')"
          >Blog</v-btn
        >
      </v-card-actions>
    </v-card>
